...
public final class TableColumn {
    ...
    */
    ...
    public static final String ASSIGNMENT_TEACHER_ID = "id_teacher";
    public static final String ASSIGNMENT_SUBJECT_ID = "id_subject";
    public static final String ASSIGNMENT_GROUP_ID = "id_group";
