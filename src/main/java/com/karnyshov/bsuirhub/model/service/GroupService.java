...
public interface GroupService {
     ...
     * @throws ServiceException if an error occurred executing the method.
     */
    int filter(int start, int size, GroupFilterCriteria criteria, String keyword, List<Group> result)
     ...
     * @throws ServiceException if an error occurred executing the method.
     */
    int filter(int start, int size, List<Group> result) throws ServiceException;
