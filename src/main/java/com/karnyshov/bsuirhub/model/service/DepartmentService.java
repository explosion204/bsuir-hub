...
public interface DepartmentService {
     ...
     * @throws ServiceException if an error occurred executing the method.
     */
    long filter(int start, int size, DepartmentFilterCriteria criteria, String keyword, List<Department> result)
     ...
     * @throws ServiceException if an error occurred executing the method.
     */
    long filter(int start, int size, List<Department> result) throws ServiceException;
