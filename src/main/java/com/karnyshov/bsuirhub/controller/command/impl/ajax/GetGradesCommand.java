...
import com.karnyshov.bsuirhub.util.EnumJsonSerializer;
...
public class GetGradesCommand implements Command {
    ...
    static {
        ...
        builder.registerTypeAdapter(Grade.Value.class, new EnumJsonSerializer<>());
        gson = builder.create();
    }
    ...
    private void processDatatableRequest(HttpServletRequest request, Map<String, Object> response)
        ...
        long recordsFetched = gradeService.findByStudentAndSubject(page, length, studentId, subjectId, grades);
