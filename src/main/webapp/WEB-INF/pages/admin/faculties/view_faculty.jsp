...
<main class="d-flex flex-row h-100">
    ...
    <div class="admin-main-area w-100 h-auto">
        <div class="container">
            <h1 class="display-3">
                <c:choose>
                    <c:when test="${newEntityPage}"><bht:localeTag key="new_faculty" /></c:when>
                    <c:otherwise><bht:localeTag key="edit_faculty" /></c:otherwise>
                </c:choose>
            </h1>
        </div>
        <hr>
            ...
            <c:otherwise>
                ...
                <c:if test="${entityUpdateSuccess}">
                    <div class="alert alert-success" role="alert">
                        <bht:localeTag key="faculty_updated" />
                    </div>
                </c:if>
                ...
                <div class="form-group me-5 ms-5 mb-2">
                    ...
                    <div class="invalid-feedback">
                        <bht:localeTag key="faculty_name_validation" />
                    </div>
                </div>
                <div class="form-group me-5 ms-5 mb-2">
                    ...
                    <div class="invalid-feedback">
                        <bht:localeTag key="faculty_short_name_validation" />
                    </div>
                </div>
